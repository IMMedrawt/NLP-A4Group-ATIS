...
def main():
    ...
    output_dir = f'../outputs/{dataset_name}_feedforward_{split_type}'
    ...
    clf = FeedforwardClassifier(input_dim=X_train_vec.shape[1])
    ...
    print(f"[Feedforward Classifier] Accuracy on {split_type} (filtered classes): {acc:.4f}")
